...
CREATE TABLE `ligas` (
  `ID_LIGA` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID_LIGA`),
  CONSTRAINT `NUMERO_JUGADORES` CHECK ((`NUMERO_JUGADORES` between 1 and 24))
...
INSERT INTO `ligas` VALUES (1,'LIGA FRANCOLACHUPA','FRANCOLACHUPA','SI FRANCO FALLA UN PUNTO LA TIENE QUE CHUPAR','BARCELONA',12),(2,'LIGA FUTBOL GALACTIC','1234','11 PUNTOS, CAMBIO DE SAQUE CADA 5','CORNELLA',24);
